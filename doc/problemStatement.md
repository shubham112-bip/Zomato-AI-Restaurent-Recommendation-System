...
Deploy the backend recommendation application on Streamlit.
Host the data processing, filtering logic, and LLM-powered recommendation generation through Streamlit app services.

Frontend Deployment (Vercel)
Deploy the frontend user interface on Vercel.
Serve the web application that captures user preferences and displays recommendation results.
